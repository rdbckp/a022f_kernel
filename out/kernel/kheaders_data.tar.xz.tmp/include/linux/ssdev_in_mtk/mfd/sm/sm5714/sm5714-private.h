...
enum sm5714_irq {
    SM5714_MUIC_IRQ_WORK = (-2),            
    SM5714_MUIC_IRQ_PROBE = (-1),           
    
    SM5714_MUIC_IRQ_INT1_DPDM_OVP = 0,      
    SM5714_MUIC_IRQ_INT1_VBUS_RID_DETACH,   
    SM5714_MUIC_IRQ_INT1_RID_DETECT,        
    SM5714_MUIC_IRQ_INT1_CHGTYPE,           
    SM5714_MUIC_IRQ_INT1_DCDTIMEOUT,        
    
    SM5714_MUIC_IRQ_INT2_AFC_ERROR,         
    SM5714_MUIC_IRQ_INT2_AFC_STA_CHG,       
    SM5714_MUIC_IRQ_INT2_MULTI_BYTE,        
    SM5714_MUIC_IRQ_INT2_VBUS_UPDATE,       
    SM5714_MUIC_IRQ_INT2_AFC_ACCEPTED,      
    SM5714_MUIC_IRQ_INT2_AFC_TA_ATTACHED,   
    
    SM5714_CHG_IRQ_INT1_VBUSLIMIT,          
